...
unsigned int Pos;
int pos=300,intdegree4=200,onoff,response_time = 5,response_time_4 = 2,loop_check = 0,response_time_fast = 20,action_delay = 600,potentiometru=0,potentiometru1=0;
const int spozbaseinf=200,spozbasesup=400,spozcot=420,spozwristz=200,spozwristspin=255;
float vdegree=200,vdegree4=200;
void moveBaseSup(float degree)
{
 degree=degree*4;
 HCPCA9685.Servo(servobaseinfpos,degree);
}
void moveClaw(float degree11)
{
    degree11=(degree11-60)*12;
 if(degree11>25)HCPCA9685.Servo(servoclawpos,degree11);
